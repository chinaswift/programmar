...
<div class="container">
	...
	<div class="user">
		...
		@if($user->followingUser)
			<a href="#" ng-cloak ng-init="following=true;" class="btn btn-danger" ng-show="following" ng-click="unfollowUser('{{$user->username}}');"><span class="octicon octicon-mark-github"></span>Unfollow</a>
			<a href="#" ng-cloak class="btn btn-primary" ng-hide="following" ng-click="followUser('{{$user->username}}');"><span class="octicon octicon-mark-github"></span>Follow</a>
		@else
			@if($user->id != Auth::user()->id)
				<a href="#" ng-cloak class="btn btn-danger" ng-show="following" ng-click="unfollowUser('{{$user->username}}');"><span class="octicon octicon-mark-github"></span>Unfollow</a>
				<a href="#" ng-cloak class="btn btn-primary" ng-hide="following" ng-click="followUser('{{$user->username}}');"><span class="octicon octicon-mark-github"></span>Follow</a>
			@endif
		@endif
	</div>
